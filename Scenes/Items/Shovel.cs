...
namespace GodotSurvivor.Scenes.Items
{
	...
	public partial class Shovel : Node, IAbility
	{
		...
		private List<Upgrade> CreateUpgrades()
		{
			...
			{
				new("shovel.slow", "Slow", "50% chance to apply Slow", UpgradeType.Ability, Metadata.Name, new Action(() => this.AddApplyableStatus(nameof(Slow), 0.5f, Slow.CreateCustomPackedScene(0.3f, 5f))), null, 1, Metadata.TexturePath, CollectibleId)
			};
		}
